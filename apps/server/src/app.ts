...
import { ProjectStore, PROJECT_LIMITS } from './projects/projects.js';
import { CrashReportStore } from './crashes/crash-store.js';
import type { RateLimitCategory, RateLimitConfig } from './core/rate-limiter.js';
import { writeAdminRuntimeFile, cleanupAdminRuntimeFile } from './admin/admin-access.js';
import { registerAdminPanel } from './admin/admin-panel.js';
import { acquireDatastoreLock, type DatastoreLock } from './core/datastore-lock.js';
import { logger } from './core/logger.js';
import { getClientIp } from './core/client-ip.js';
import { createPresenceState, getActiveRoomsCount as getActiveRoomsCountHelper } from './rooms/presence.js';
import { ensureRoomProjectAccess } from './projects/project-sync.js';
import { revalidateActiveSessions } from './rooms/session-lifecycle.js';
