...
import { applyLyricsPermissions } from '../lyrics/lyricsUi';
import { applyNotesPermissions } from '../notes/notesUi';
import { applyTasksPermissions } from '../tasks/tasksUi';
import { applyStructurePermissions } from '../structure/structureUi';
