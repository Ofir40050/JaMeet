...
_Static_assert(offsetof(JaMeetAudioSlot, publishSequence) == 0, "publishSequence offset must be 0");
...
static_assert(offsetof(JaMeetAudioSlot, publishSequence) == 0, "publishSequence offset must be 0");
